...
$(document).ready(function () {
    ...
    var table = $('#example').DataTable({
        ...
        "ajax": {
            "url": "/ProductDocument/TableDataJson",
            "type": "POST",
            "datatype": "json",
            "data": function (d) {
                if (userHasSorted) {
        ...
        "columns": [
            ...
            },
            {
                "data": null, render : function(data, type, row) {
                    return `<a href="/uploads/ProductCharacteristics/${row.mediaName}" target="_blank">/${row.mediaName}</a>`;	
                }
            },
            {
                "data": "language.name"
            ...
            },
            {
                ...
                "data": null, "render": function (row) {
                    ...
                    var id = row.id,
                    buttons = `
                        <a class='btn btn-warning me-1' href="/ProductCharacteristicUpdate/${id}" data-bs-toggle="tooltip" title="Update Characteristic"><i class="fa-solid fa-pen"></i></a>
                        <button type="button" class="btn btn-danger deleteButton me-1" data-id="${id}" data-bs-toggle="tooltip" title="Delete Characteristic">
        ...
        iziToast.question({
            ...
            buttons: [
                ['<button><b>YES</b></button>', function (instance, toast) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: '/ProductDocument/RemoveJson',
                        data: {
                            "id": id
                        },
