function format(d) {
    ...
    var languageSpeaker = d.languageSpeaker;
    var languages = "";

    if (languageSpeaker) {
        let badges = languageSpeaker
        ...
        "columns": [
            ...
            },
            {
                ...
                "data": null, "render": function (row) {
                    ...
                    var id = row.id,
                    buttons = `
                        <a class='btn btn-warning me-1' href="/SpeakerUpdate/${id}" data-bs-toggle="tooltip" title="Update Speaker"><i class="fa-solid fa-pen"></i></a>
                        <button type="button" class="btn btn-danger deleteButton me-1" data-id="${id}" data-bs-toggle="tooltip" title="Delete Speaker">
