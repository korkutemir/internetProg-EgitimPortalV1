        ...
        "columns": [
            ...
            },
            {
                ...
                "data": null, "render": function (row) {
                    ...
                    var id = row.id,
                    buttons = `
                        <a class='btn btn-warning me-1' href="/ProductGroupUpdate/${id}" data-bs-toggle="tooltip" title="Update Product Group"><i class="fa-solid fa-pen"></i></a>
                        <button type="button" class="btn btn-danger deleteButton" data-id="${id}" data-bs-toggle="tooltip" title="Delete Product Group">
