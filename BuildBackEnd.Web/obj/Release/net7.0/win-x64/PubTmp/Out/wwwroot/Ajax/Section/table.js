function format(d) {
    ...
    var languageSections = d.languageSections;
    var languages = "";

    if (languageSections) {
        let badges = languageSections
        ...
        "columns": [
            ...
            },
            {
                ...
                "data": null, "render": function (row) {
                    ...
                    var id = row.id;
                    var buttons = `<a class='btn btn-warning me-1' href="/SectionUpdate/${id}" data-bs-toggle="tooltip" title="Update Solution"><i class="fa-solid fa-pen"></i></a>
                                   <button type="button" class="btn btn-danger deleteButton" data-id="${id}" data-bs-toggle="tooltip" title="Delete Solution"><i class="fa-solid fa-trash"></i></button>`;
                    return buttons;
