...
$(document).ready(function () {
    ...
    var table = $('#example').DataTable({
        ...
        "ajax": {
            "url": "/CharacteristicDocument/TableData",
            "type": "POST",
            "datatype": "json",
            "data": function (d) {
                if (userHasSorted) {
                ...
                d.characteristicId = $("#characteristicId").val();
            },
        },
        "rowId": 'id',
        "columns": [
            ...
            },
            {
                ...
                "data": null, "render": function (row) {
                    return `
                        <a href="/Uploads/characteristics/${row.mediaName}" target="_blank">
                            <img src="/Uploads/characteristics/${row.mediaName}" class="img-fluid" alt="Responsive image" style="max-width: 100px; max-height: 100px;">
                        </a>
                   `;
                }
            ...
            },
            {
                ...
                "data": null, "render": function (row) {
                    ...
                    var buttons = `
                    <a class='btn  btn-warning me-1' href="/CharactericticDocumentUpdate/${id}" ><i class="fa-solid fa-pen"></i></a>
                    <button type="button" class="btn  btn-danger me-1 deleteButton" data-id="${id}" ><i class="fa-solid fa-trash"></i></button>
                  `;
