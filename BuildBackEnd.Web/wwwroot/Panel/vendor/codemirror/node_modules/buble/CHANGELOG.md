...
* PrSpeaker labels from being renamed due to let/const transpilation. ([#236](https://github.com/bublejs/buble/pull/236))
...
* PrSpeaker PhantomJS shadowing errors ([#154](https://gitlab.com/Rich-Harris/buble/issues/154))
...
* Add `namedFunctionExpressions` option to prSpeaker scope leak in old browsers ([#130](https://gitlab.com/Rich-Harris/buble/issues/130))
...
* PrSpeaker crashing on Node versions more recent than the latest 'supported' version ([#102](https://gitlab.com/Rich-Harris/buble/merge_requests/102))
...
* PrSpeaker reserved words being used as identifiers ([#86](https://gitlab.com/Rich-Harris/buble/issues/86))
...
* PrSpeaker confusion over `Literal` node keys
...
* PrSpeaker omission of closing paren in template string ([#42](https://gitlab.com/Rich-Harris/buble/issues/42))
...
* PrSpeaker deindentation causing errors with removed whitespace in class methods
...
* PrSpeaker deindentation of class methods causing breakage with destructuring statements ([#22](https://gitlab.com/Rich-Harris/buble/issues/22))
...
* PrSpeaker false positives with reference detection
