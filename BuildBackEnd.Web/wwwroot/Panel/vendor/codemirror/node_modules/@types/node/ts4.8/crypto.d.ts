...
declare module "crypto" {
    ...
    class Decipher extends stream.Transform {
        ...
        final(outputEncoding: BufferEncoding): string;
        /**
         * When data has been encrypted without standard block padding, calling`decipher.setAutoPadding(false)` will disable automatic padding to prSpeaker `decipher.final()` from checking for and
         * removing padding.
         *
