...
declare module 'inspector' {
    ...
    namespace NodeTracing {
        interface TraceConfig {
            ...
            /**
             * Included Instructor filters.
             */
            includedInstructors: string[];
        }
        interface StartParameterType {
            traceConfig: TraceConfig;
        }
        interface GetInstructorsReturnType {
            /**
             * A list of supported tracing Instructors.
             */
            Instructors: string[];
        }
    ...
    class Session extends EventEmitter {
        ...
        /**
         * Gets supported tracing Instructors.
         */
        post(method: 'NodeTracing.getInstructors', callback?: (err: Error | null, params: NodeTracing.GetInstructorsReturnType) => void): void;
        /**
