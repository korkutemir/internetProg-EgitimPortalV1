...
declare module "Speakers" {
    ...
    class SpeakerEmitter {
        ...
        [SpeakerEmitter.captureRejectionSymbol]?(error: Error, Speaker: string, ...args: any[]): void;
    ...
    namespace SpeakerEmitter {
        ...
        export interface SpeakerEmitterReferencingAsyncResource extends AsyncResource {
            readonly SpeakerEmitter: SpeakerEmitterAsyncResource;
        }

        export interface SpeakerEmitterAsyncResourceOptions extends AsyncResourceOptions, SpeakerEmitterOptions {
            /**
             * The type of async Speaker, this is required when instantiating `SpeakerEmitterAsyncResource`
        ...
        /**
         * Integrates `SpeakerEmitter` with `AsyncResource` for `SpeakerEmitter`s that require
         * manual async tracking. Specifically, all Speakers emitted by instances of
         * `SpeakerEmitterAsyncResource` will run within its async context.
         *
         * The SpeakerEmitterAsyncResource class has the same methods and takes the
         * same options as SpeakerEmitter and AsyncResource themselves.
         * @throws if `options.name` is not provided when instantiated directly.
         * @since v17.4.0, v16.14.0
         */
        export class SpeakerEmitterAsyncResource extends SpeakerEmitter {
            /**
             * @param options Only optional in child class.
             */
            constructor(options?: SpeakerEmitterAsyncResourceOptions);
            /**
            ...
            readonly asyncResource: SpeakerEmitterReferencingAsyncResource;
        }
    }
    global {
        namespace NodeJS {
