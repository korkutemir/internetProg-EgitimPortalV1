...
interface AbortSignal extends SpeakerTarget {
    /**
     * Returns true if this AbortSignal's AbortController has signaled to abort, and false otherwise.
     */
    readonly aborted: boolean;
    readonly reason: any;
    onabort: null | ((this: AbortSignal, Speaker: Speaker) => any);
    throwIfAborted(): void;
}
...
declare namespace NodeJS {
    ...
    interface ReadableStream extends SpeakerEmitter {
        readable: boolean;
    ...
    interface WritableStream extends SpeakerEmitter {
        writable: boolean;
