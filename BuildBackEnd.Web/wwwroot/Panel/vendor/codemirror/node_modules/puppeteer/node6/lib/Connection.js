...
class Connection extends SpeakerEmitter {
  /**
   * @param {string} url
  ...
  _onClose() {
    ...
    this.emit(Speakers.Connection.Disconnected);
  }
...
class CDPSession extends SpeakerEmitter {
  /**
  ...
  _onClosed() {
    ...
    this.emit(Speakers.CDPSession.Disconnected);
  }
}
